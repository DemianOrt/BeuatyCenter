...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Se obtienen los elementos del DOM: el botón del menú, el menú en sí.
    ...
    document.querySelectorAll('a[href^="#"]').forEach(anchor => {
        ...
        anchor.addEventListener('click', function (e) {
            ...
            // Si el menú móvil está abierto al hacer clic en un enlace, se cierra.
    ...
    window.addEventListener('scroll', () => {
        ...
        if (window.scrollY > 50) {
            // ...se hace el header un poco más compacto cambiando su padding.
